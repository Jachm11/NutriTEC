...
namespace NutriTEC.Data.Repositories.Query
{
    public class RecetaRepository : IRecetaRepository
    {
        ...
        public object InsertRecipe(int id_cliente, string nombre)
        {
            ...
            object id = GetOneRecipeDetail(dt);

            if (id == null) return "No se ha logrado agregar la receta. Por favor intente más tarde.";
            return id;
;
        }
        ...
        public string UpdateProduct(int id, int id_producto, float porciones)
        {
            ...
            cmd.Parameters.AddWithValue("@StatementType", "UpdateProduct");
            ...
            if (i < 1) return "No se ha logrado actualizar el producto de la receta. Por favor intente más tarde.";
            return "";
        }
            ...
            foreach (DataRow dr in dt.Rows)
            {
                list.Add(
                    new
                    {
                        ...
                        Porciones = float.Parse(Convert.ToString(dr["porcion_agregada"])),
                        Tamano_porcion = float.Parse(Convert.ToString(dr["medida_porcion"])),
        ...
        private static object GetOneRecipeDetail(DataTable dt)
        {
            ...
            if (dt.Rows.Count == 1)
            {
                ...
                recipe = new
                {
                    ...
                    Id_cliente = Convert.ToString(dt.Rows[0]["id_cliente"]),
